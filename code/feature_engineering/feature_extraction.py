...
def generate_data_matrix_and_vector(feature_file,alarm_file,merged_data_file):
    ...
    # merged_df['archour'] = merged_df['archour'].apply(lambda x: datetime.datetime.strptime(x,'%Y-%m-%d %H:%M:%S'))
    # print( merged_df[merged_df['archour'] < "2018-01-24 00:00:00"]['event'].value_counts())
